...
if (!TURSO_DATABASE_URL || !TURSO_AUTH_TOKEN) {
  console.warn("⚠️ Missing TURSO_DATABASE_URL or TURSO_AUTH_TOKEN. Set them in Vercel Environment Variables.");
}
...
app.get(["/it", "/it/"], (req, res) => {
  ...
  return res.sendFile(path.join(__dirname, "it", "public", "app.html"));
});
app.get("/universe", (req, res) => res.redirect("/universe/index.html"));
